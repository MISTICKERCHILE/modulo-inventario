window.cambiarSubTabPedidos = function(subtab) {
    ...
    [btnS, btnT, btnP, btnH].forEach(b => { if(b) b.className = 'px-6 py-3 font-medium text-gray-500 hover:text-gray-700 transition-colors whitespace-nowrap'; });
    ...
    if(subtab === 'sugerencias') {
        ...
        if(btnH) btnH.className = 'px-6 py-3 font-medium border-b-2 border-slate-800 text-slate-800 bg-slate-50/50 whitespace-nowrap';
