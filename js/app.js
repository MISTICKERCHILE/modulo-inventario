        ...
        <tr id="acciones-${p.id}" class="hidden bg-slate-100/60 border-b border-slate-200">
            <td colspan="3" class="px-6 py-3">
                <div class="flex justify-end gap-6 items-center">
                    ...
                    <button onclick="alert('La edición estará lista en la Fase 3')" class="text-blue-600 font-bold hover:underline flex items-center gap-1"><span>✏️</span> Editar</button>
